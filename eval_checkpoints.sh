...
eval_results() {
    ...
    if [[ $1 == *"best_model" ]]; then
        ...
        python evaluation.py \
            ...
            --mode test --mask_embedding_sentence\
            --task_set transfer\
            --mask_embedding_sentence_template $TEMPLATE --lora_weight  $1 --load_kbit 4 ${args[@]}
        ...
        python evaluation.py \
            ...
            --mode test --mask_embedding_sentence \
            --task_set transfer\
            --mask_embedding_sentence_template $TEMPLATE --load_kbit 4 
    fi
